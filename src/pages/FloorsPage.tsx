...
const demoFloors = [
  {
    name: 'Sewing Floor 1 (SF-01)', lines: [
  ...
  {
    name: 'Sewing Floor 2 (SF-02)', lines: [
  ...
  {
    name: 'Sewing Floor 3 (SF-03)', lines: [
  ...
  {
    name: 'Finishing Floor (FF-01)', lines: [
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">4 floors · 12 active lines</p>
      </div>

      {demoFloors.map((floor, fi) => (
