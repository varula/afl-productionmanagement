    ...
    <Card className="border border-border/60 shadow-sm hover:shadow-md transition-shadow h-full">
      <CardContent className="p-4 flex flex-col h-full">
        <div className="flex items-center justify-between mb-3">
          <div>
            <div className="text-[13px] font-bold text-foreground leading-tight">Employee Turnover</div>
            <div className="text-[10px] text-muted-foreground">Monthly workforce stability</div>
          </div>
          <span className="text-[8px] font-semibold text-pink bg-pink/10 px-1.5 py-0.5 rounded border border-pink/20 shrink-0">
            Target &lt;3%
          </span>
        </div>
