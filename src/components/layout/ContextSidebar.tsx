...
const STATIC_SIDEBAR_CONFIG: SidebarConfig = {
  ...
  '/lost-time': [
    { title: 'Filter By', items: [
      ...
      { label: 'Unresolved', key: 'lt-open', badge: 2 },
      { label: 'Resolved', key: 'lt-resolved' },
      { label: 'High Impact', key: 'lt-high', badge: 3 },
    ]},
    { title: 'By Reason', items: [
      { label: 'Machine B/D', key: 'lt-machine', badge: 4 },
      { label: 'No Input', key: 'lt-noinput', badge: 3 },
      { label: 'QC Hold', key: 'lt-qchold', badge: 1 },
      { label: 'Power', key: 'lt-power', badge: 1 },
      { label: 'Needle/Thread', key: 'lt-needle', badge: 3 },
      { label: 'Style Change', key: 'lt-style', badge: 1 },
      { label: 'Meeting', key: 'lt-meeting', badge: 1 },
    ]},
    { title: 'By Floor', items: [
      { label: 'SF-01', key: 'lt-sf01' },
      { label: 'SF-02', key: 'lt-sf02', badge: 3 },
      { label: 'SF-03', key: 'lt-sf03', badge: 3 },
      { label: 'FF-01', key: 'lt-ff01' },
      { label: 'FF-02', key: 'lt-ff02', badge: 2 },
      { label: 'CF-01', key: 'lt-cf01', badge: 1 },
    ]},
  ],
  '/workers': [
    { title: 'By Floor', items: [
